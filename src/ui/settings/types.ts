...
export interface SettingsCtx {
  ...
  /**
   * Видимый текст по ключу каталога (10.13.38). Нужен своим блокам: у записи
   * `kind: "custom"` нет ни `name`, ни `desc`, и подстановка, которая идёт по
   * схеме, до её текстов не достаёт. Второй аргумент — то, что написано в
