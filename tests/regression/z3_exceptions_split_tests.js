...
const ORDINALS = [
  ...
  "сто сорок первое",
  "сто сорок второе",
  "сто сорок третье", "сто сорок четвёртое", "сто сорок пятое",
  "сто сорок шестое",
  "сто сорок седьмое",
  "сто сорок восьмое",
  "сто сорок девятое",
  "сто пятидесятое",
  "сто пятьдесят первое",
  "сто пятьдесят второе",
  "сто пятьдесят третье",
  "сто пятьдесят четвёртое",
  "сто пятьдесят пятое",
  "сто пятьдесят шестое",
  "сто пятьдесят седьмое",
];
