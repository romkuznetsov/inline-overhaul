...
(async function run() {
  ...
  /* ---- Continue past Separators у переноса текста ----------------------
   *
   ...
   */
  {
    ...
    ok("выключенный Continue past Separators держит текст между разделителями");
    ...
    ok("включённый Continue past Separators оставляет прежнее поведение");
