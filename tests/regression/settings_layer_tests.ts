...
async function main(): Promise<void> {
  ...
  await test("перенесены все группы с настройками", () => {
    assert.equal(SCHEMA.length, 41,
      ...
      + "Группа `Smart Enter` заведена 2026-09-13 по его заказу (10.13.88): . Группа `Links in the notes you mention` заведена 2026-09-17 по его заказу Н4 (10.13.184): ссылка на новую заметку уезжает в те заметки, на которые ссылалась строка. Группа `TagWheel Scroller` отделена от `TagWheel` 2026-09-17: предел в двенадцать настроек на группу (Г11). Группа `Jump highlight` заведена 2026-09-17 его словом «перенеси все настройки jump-flash в Visual отдельным блоком настроек»: строки не новые — они ушли из группы `Moving cursor inside a note` вместе со своей веткой конфига"
  ...
  await test("ни одна группа не потерялась молча", () => {
    ...
    assert.equal(SCHEMA.length + AWAITED.length, 41,
      "41 группа прототипа разложена без остатка: `TagWheel Scroller` отделена от `TagWheel` 2026-09-17 — с новой строкой `Chosen Value text color` в той группе стало тринадцать настроек при пределе двенадцать (Г11), и скроллер в ней единственная связная пятёрка; `Jump highlight` заведена 2026-09-17 его словом «перенеси все настройки jump-flash в Visual отдельным блоком настроек» — строки не новые, они ушли из группы `Moving cursor inside a note`; группа Note properties удалена 2026-08-28 (её настройки уехали к Field, 10.9), группа Options IDs добавлена в тот же день, Binder перенесён 2026-08-29, тогда же заведена группа Color your Tags, Backup заведена 2026-08-31 (10.13.2), а Config note и Generated files сняты 2026-09-03 вместе с конфиг-заметкой (10.12); Smart Delete и Text cursor заведены 2026-09-05 вечером по заказу (10.13.32 и 10.13.33), а Language — 2026-09-06 вместе с каталогом текстов (10.13.38), группа `TagWheel opening` заведена 2026-09-12 вместе с контролом ведущего поля (10.13.76), `Smart Enter` — 2026-09-13 по его заказу (10.13.88), а `Links in the notes you mention` — 2026-09-17 по его заказу Н4 (10.13.184)");
  });
