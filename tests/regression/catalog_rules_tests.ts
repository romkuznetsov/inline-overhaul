...
const RULES: readonly Rule[] = [
  ...
  },
  {
    ...
    why: "чтение перед записью — законное; каталог требует cachedRead только "
      + "там, где читают для показа. Планка опущена с шести 2026-09-11: "
      + "навигация перестала читать служебный файл правил и берёт их из "
      + "настроек (PRD 10.13.52, П-8, шаг первый)",
  },
];
