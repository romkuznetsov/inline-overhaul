  ...
  visible: on("general.help.showCallouts") },
{
  ...
  items: [
    ...
    { kind:"slider", id:"tags-block-fill-height", path:"visual.tags.blockFill.heightPx", default:3,
      ...
      visible: on("visual.tags.blockFill.enabled") },
    { kind:"slider", id:"tags-block-fill-width", path:"visual.tags.blockFill.widthPct", default:60,
      min:0, max:100, step:5, unit:"%",
      name:"Band width", desc:"How far the band reaches to either side, towards the Separator",
    ...
    { kind:"slider", id:"tags-bubble-height", path:"visual.tags.bubbleHeightPct", default:100,
      min:80, max:140, step:5, unit:"%",
      name:"Tags bubble size", desc:"How tall the bubble is around the word",
