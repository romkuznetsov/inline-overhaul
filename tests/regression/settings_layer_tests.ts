...
async function main(): Promise<void> {
  ...
  await test("перенесены все группы с настройками", () => {
    assert.equal(SCHEMA.length, 39,
      ...
      + "Группа `Smart Enter` заведена 2026-09-13 по его заказу (10.13.88): . Группа `Links in the notes you mention` заведена 2026-09-17 по его заказу Н4 (10.13.184): ссылка на новую заметку уезжает в те заметки, на которые ссылалась строка"
