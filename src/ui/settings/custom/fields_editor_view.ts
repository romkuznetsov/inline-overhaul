 ...
 *
 * Положений три (его слово 2026-09-19): `After parent` — поле появляется
 * после значения родителя, так было всегда, и это умолчание; `Show always` —
 * оно работает и на строке без родителя, а команды листают все его значения
 * подряд; `Hide` — поля нет ни в TagWheel, ни в его командах.
 *
