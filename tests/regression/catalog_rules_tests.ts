...
const RULES: readonly Rule[] = [
  ...
  },
  {
    ...
    why: "чтение перед записью — законное; каталог требует cachedRead только "
      + "там, где читают для показа. Планка опускалась дважды по одной "
      + "причине: с шести до пяти 2026-09-11 (навигация перестала читать "
      + "служебный файл правил) и с пяти до четырёх 2026-09-13 — файла не "
      + "читает больше ни один движок, включая панель TagWheel "
      + "(PRD 10.13.52, П-8, шаги первый и третий)",
  },
];
