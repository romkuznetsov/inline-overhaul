...
async function main(): Promise<void> {
  ...
  await test("перенесены все группы с настройками", () => {
    assert.equal(SCHEMA.length, 38,
      "групп в схеме: 23 с настройками, 7 вводных коллаутов, группа Fields, "
