...
},
{
  ...
  items: [
    ...
    { kind:"text", id:"content-target-header", path:"transform.inline2note.placement.targetHeader",
    ...
    { kind:"dropdown", id:"content-header-missing", path:"transform.inline2note.placement.fallback",
      default:"end",
      name:"If header not found", desc:"Where the text goes when the note has no such heading",
      options:[ {value:"beginning",label:"At the beginning"}, {value:"end",label:"At the end"} ],
