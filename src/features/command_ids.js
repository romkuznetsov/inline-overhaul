 ...
 * `undo-last-settings-change`. Ломать
 ...
 *
 * **Здесь ровно те команды, которые плагин регистрирует.** Исключений в этой
 * карте больше нет: `open-inline-overhaul-settings` стояла здесь единственной
 * строкой, которой нет в прототипе, — и вместе с ней стояли три исключения в
 * проверках («имя не сверяется с прототипом», «команда не названа в
 * руководстве», «строка справочника не рисуется»). Команда снята 2026-09-06
 * (T8, фаза 6 пункт 5), исключения сняты тем же заходом: исключение живёт
