...
const KNOWN = [
  {
    when: (r) => r.source === "ссылка в зоне значений",
    why: "команда поля-родителя уносит со строки значение зависимого поля, а панель его оставляет: правило «сменил родителя — очисти зависимых» объявлено у команд и не объявлено у панели",
    where: "PRD 10.13.128, вопрос В-116 в docs/OPEN_QUESTIONS.md",
    since: "2026-09-15",
    seen: 0,
  },
  {
